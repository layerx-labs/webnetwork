...
const options = yargs(hideBin(process.argv))
  ...
  .option(`paymentToken`, {alias: `p`, type: `string`, desc: `use these addresses as transactional token`})
  .option(`governanceToken`, {alias: `g`, type: `string`, desc: `use these addresses as governance token`})
  .option(`bountyNFT`, {alias: `b`, type: `string`, desc: `use these addresses as bounty token`})
